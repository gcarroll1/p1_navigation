...
This project is a Python Deep Reinforcement Learning application using PyTorch to train an agent to navigate (and collect bananas!) in a large, square world.  
